...
#define RING_LEFT_BOTTOM_BASE_COL      47u
#define RING_RIGHT_BOTTOM_BASE_COL     141u
...
/* Map the same-side raw lower corner around the quarter-width base. */
...
void Ring_Ring_Ring(void)
{
    ...
    if (minPoint > PIXEL_OFFSET &&
        ...
        right_control_line[SEARCH_IMAGE_H - 1] =
            Ring_Adjust_Bottom_Anchor(RING_LEFT_BOTTOM_BASE_COL,
...
static void Ring_Ring_Ring_Right(void)
{
    ...
    left_control_line[SEARCH_IMAGE_H - 1] =
        Ring_Adjust_Bottom_Anchor(RING_RIGHT_BOTTOM_BASE_COL,
